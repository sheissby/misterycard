...
#调用压缩、解压脚本
from haiyi_zdh.all_public import zipfile1
...
##    att2["Content-Disposition"] = 'attachment; filename="医学院项目(firefox下)自动化测试报告.html"' 
##    msg.attach(att2)
...
def sendreport():
    ...
    #定义报告的相对路径++++++++++++++++++++++++++++++++++++++++++++++++++
    result_dir = os.getcwd().split('public')[0]+'\\report\\firefox'
