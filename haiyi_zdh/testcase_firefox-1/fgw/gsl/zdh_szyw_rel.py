...
class zdh_szyw_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='gsl_rel'+now
        self.img_text='img_gsl_rel_error'
    
    def test_zdh_szyw_rel(self):
        u"""发布时政要闻"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-52579fde-d317-4ad1-a503-42274373eb2a']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(self.rel_text)
