...
class zdh_szyw_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='gsl_add'+now
        self.img_text='img_gsl_add_error'
    
    def test_zdh_szyw_add(self):
        u"""添加时政要闻"""
        driver = self.driver
        ...
        #选择窗口2（即添加窗口）
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_04872edc_5b8f_417f_aaa4_4d02f2a52cd4_IbtnAppend']").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(self.add_text)
