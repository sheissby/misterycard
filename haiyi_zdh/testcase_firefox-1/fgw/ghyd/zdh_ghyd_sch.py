...
class zdh_ghyd_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='ghyd_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_ghyd_sch_error'
        
    def test_zdh_ghyd_sch(self):
        u"""查询工会园地"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").send_keys(self.sch_text)
