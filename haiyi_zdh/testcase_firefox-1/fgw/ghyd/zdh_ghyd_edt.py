...
class zdh_ghyd_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_ghyd_edt_error'
    
    def test_zdh_ghyd_edt(self):
        u"""修改工会园地"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
