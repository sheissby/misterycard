...
class zdh_ghyd_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='ghyd_add'+now
        self.img_text='img_ghyd_add_error'
    
    def test_zdh_ghyd_add(self):
        u"""添加工会园地"""
        driver = self.driver
        ...
        #选择窗口2（即添加窗口）
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_be0c1900_f779_4d9f_b78c_777fe8752e13_IbtnAppend']").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").send_keys(self.add_text)
