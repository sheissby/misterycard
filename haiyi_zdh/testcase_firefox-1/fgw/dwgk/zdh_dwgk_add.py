...
class zdh_dwgk_add(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='dwgk_add'+now
        self.img_text='img_dwgk_add_error'
        print u'---------------《添加党务公开功能自动化测试》----------------------'
    
    def test_zdh_dwgk_add(self):
        u"""添加党务公开"""
        ...
        driver.find_element_by_xpath(".//*[@id='Control_605af416_b00c_4db9_9e0e_37f13214890d']").send_keys(self.add_text)
        ...
        try:
            ...
            print u'(1)【通过】：添加的信息列表里存在，名称“'+self.add_text+'”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'(1)【错误】：添加的信息列表里没有存在，名称“'+self.add_text+'”'
