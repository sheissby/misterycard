...
class zdh_cymb_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='cymb_rel'+now
        self.img_text='img_cymb_rel_error'
    
    def test_zdh_cymb_rel(self):
        u"""发布常用模板"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-7a455c6e-86a7-4965-a67e-8dd2bb8ef42e']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_c1257236_9113_4377_a0c0_8dbadafb0f80']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_c1257236_9113_4377_a0c0_8dbadafb0f80']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
