...
class zdh_cymb_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_cymb_edt_error'
    
    def test_zdh_cymb_edt(self):
        u"""修改常用模板"""
        driver = self.driver
        ...
        time.sleep(1)
        #获取属性值（除标题和内容）
        fbfw_add_text=driver.find_element_by_xpath(".//*[@id='Page_RightControlId_txbText']").get_attribute('value')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandles[2])
        try:
            fbfw_text=driver.find_element_by_xpath(".//*[@id='Page_RightControlId_txbText']").get_attribute('value')
        ...
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
