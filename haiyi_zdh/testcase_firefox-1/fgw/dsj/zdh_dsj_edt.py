...
class zdh_dsj_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_dsj_edt_error'
    
    def test_zdh_dsj_edt(self):
        u"""修改大事记"""
        driver = self.driver
        ...
        time.sleep(1)
        #添加信息
        edt_text='dsj_edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        ...
        #完成添加
        #修改信息
        edt2_text='dsj_2edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        ...
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
