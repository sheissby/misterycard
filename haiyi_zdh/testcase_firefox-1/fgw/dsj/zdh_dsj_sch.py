...
class zdh_dsj_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='dsj_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_dsj_sch_error'
        
    def test_zdh_dsj_sch(self):
        u"""查询大事记"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(self.sch_text)
