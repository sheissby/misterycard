...
#案例
class zdh_txl_add(unittest.TestCase):
    def setUp(self):
        #调用登录函数
        ...
        #通讯录标题
        self.add_text=u'系统管理'
        
    def test_zdh_txl_add(self):       
        ...
        driver.find_element_by_id("txbMobilePhoneNum").send_keys(u"13398992001")
        ...
        #输入查询人员
        driver.find_element_by_id("tb_Search").send_keys(self.add_text)
        #点击查询、添加、提交人员
        ...
        driver.find_element_by_id("txbName").send_keys(self.add_text)
        ...
        try:
            ...
            print u'添加的信息列表里存在，用户名“'+self.add_text+u'”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'添加的信息列表里不存在，用户名“'+self.add_text+u'”'
        time.sleep(2)
        ...
        try:
            text=driver.find_element_by_xpath(".//*[@id='gvPhoneList']/tbody/tr[2]/td[1]").text
            self.assertEqual(text, self.add_text)
            print u'取消删除后添加的信息列表里存在，用户名“'+self.add_text+u'”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'取消删除后添加的信息列表里不存在，用户名“'+self.add_text+u'”'
        time.sleep(2)
        ...
        try:
            ...
            print u'删除信息，名称“'+self.add_text+u'”，删除成功提示语' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'删除信息，名称“'+self.add_text+u'”，删除失败提示语'  
        ...
        if len(tr)>1:
            ...
            print self.add_text+u'通讯录删除数据失败'
        else :
            print self.add_text+u'通讯录删除数据成功'
        time.sleep(2)
        #完成通讯录删除后的结果验证功能
