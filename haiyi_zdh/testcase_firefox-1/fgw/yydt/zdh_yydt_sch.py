...
class zdh_yydt_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='yydt_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_yydt_sch_error'
        
    def test_zdh_yydt_sch(self):
        u"""查询医院动态"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_3a5f0942_4b73_47a3_8301_ca5e350f6924']").send_keys(self.sch_text)
