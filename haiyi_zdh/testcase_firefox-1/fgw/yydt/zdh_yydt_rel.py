...
class zdh_yydt_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='yydt_rel'+now
    
    def test_zdh_yydt_rel(self):
        u"""发布医院动态"""
        driver = self.driver
        ...
        time.sleep(1)
        os.startfile(os.getcwd().split('testcase_firefox')[0]+'\uploadfile\Fox_fgw_jpg.exe')
        time.sleep(5)
        ...
        driver.find_element_by_xpath(".//*[@id='Control_3a5f0942_4b73_47a3_8301_ca5e350f6924']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-d3098490-e19b-4e88-8366-deb76106beaf']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_e84c0d67_d3be_410b_97b8_6e3b1cfea3cb']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_e84c0d67_d3be_410b_97b8_6e3b1cfea3cb']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
