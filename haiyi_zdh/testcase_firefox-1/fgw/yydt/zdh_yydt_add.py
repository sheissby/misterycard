...
class zdh_yydt_add(unittest.TestCase):
    ...
    def test_zdh_yydt_add(self):
        ...
        driver.find_element_by_xpath(".//*[@id='Control_3a5f0942_4b73_47a3_8301_ca5e350f6924']").send_keys(self.add_text)
