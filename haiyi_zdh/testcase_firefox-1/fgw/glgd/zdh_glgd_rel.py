...
class zdh_glgd_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='glgd_rel'+now
        self.img_text='img_glgd_rel_error'
    
    def test_zdh_glgd_rel(self):
        u"""发布管理规定"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_f080c6e8_7f60_4232_a1c9_24f6feeb8c5e']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-a8848288-613a-41eb-a7e6-c088e7e30793']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_b4ff0322_481b_4ed2_93fb_c4e2d4d7f725']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_b4ff0322_481b_4ed2_93fb_c4e2d4d7f725']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
