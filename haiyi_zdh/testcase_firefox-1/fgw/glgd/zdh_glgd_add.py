...
class zdh_glgd_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='glgd_add'+now
        self.img_text='img_glgd_add_error'
    
    def test_zdh_glgd_add(self):
        u"""添加管理规定"""
        driver = self.driver
        ...
        #选择窗口2（即添加窗口）
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_07c97e1c_f8a1_49ff_ae46_13d669977840_IbtnAppend']").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_f080c6e8_7f60_4232_a1c9_24f6feeb8c5e']").send_keys(self.add_text)
