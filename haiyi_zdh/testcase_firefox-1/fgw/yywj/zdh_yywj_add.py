...
class zdh_yywj_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='yywj_add'+now
        self.img_text='img_yywj_add_error'
    
    def test_zdh_yywj_add(self):
        u"""添加医院文件"""
        driver = self.driver
        ...
        #选择窗口2（即添加窗口）
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_5267cfa9_9dd4_4686_b296_24898eaf7f16_IbtnAppend']").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_60a7e30c_ef53_4999_a8fa_6b056075d481']").send_keys(self.add_text)
