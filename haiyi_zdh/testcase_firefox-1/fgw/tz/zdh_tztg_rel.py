...
class zdh_tztg_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='tztg_rel'+now
        self.img_text='img_tztg_rel_error'
    
    def test_zdh_tztg_rel(self):
        u"""发布通知通告"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-0d4b7579-0988-4d92-9c9d-23a8244f2034']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_7f1e01fb_4a1c_459a_a4ae_bca967b20847']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_7f1e01fb_4a1c_459a_a4ae_bca967b20847']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
