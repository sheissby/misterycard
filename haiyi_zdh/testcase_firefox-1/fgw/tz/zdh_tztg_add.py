...
class zdh_tztg_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='tztg_add'+now
        self.img_text='img_tztg_add_error'
    
    def test_zdh_tztg_add(self):
        u"""添加通知通告"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").send_keys(self.add_text)
