...
class zdh_cybg_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='cybg_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_cybg_sch_error'
        
    def test_zdh_cybg_sch(self):
        u"""查询常用表格"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_46d6558c_aa37_428b_9a50_60fd844581b3']").send_keys(self.sch_text)
