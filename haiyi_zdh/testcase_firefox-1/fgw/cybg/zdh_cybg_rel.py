...
class zdh_cybg_rel(unittest.TestCase):
    ...
    def test_zdh_cybg_rel(self):
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-51d2f10a-0092-4635-8fef-66c51b6f87e0']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_5c83bf70_fbc9_49f9_8b27_953fe062cf5e']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_5c83bf70_fbc9_49f9_8b27_953fe062cf5e']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
