...
class zdh_yywh_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='yywh_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_yywh_sch_error'
        
    def test_zdh_yywh_sch(self):
        u"""查询医院文化"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").send_keys(self.sch_text)
