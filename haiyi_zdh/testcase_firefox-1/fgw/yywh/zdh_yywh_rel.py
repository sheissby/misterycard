...
class zdh_yywh_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='yywh_rel'+now
        self.img_text='img_yywh_rel_error'
    
    def test_zdh_yywh_rel(self):
        u"""发布医院文化"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-87d60f2f-3efa-4e43-9f49-2727ebefd41e']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_de5ec581_2824_4377_8e89_68cc96114077']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_de5ec581_2824_4377_8e89_68cc96114077']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
