...
class zdh_yywh_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_yywh_edt_error'
    
    def test_zdh_yywh_edt(self):
        u"""修改医院文化"""
        driver = self.driver
        ...
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandles[1])
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
