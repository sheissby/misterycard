...
class zdh_gwjd_sub(unittest.TestCase):
    ...
    def test_zdh_gwjd_sub(self):
        ...
        #经办人选择+++++++++++++++++++++++++++++++++++++
        #双击选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[3]/td[1]/img")
        ...
        #收件人选择+++++++++++++++++++++++++++++++++++++
        #双击收件人选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[13]/td/img")
        ActionChains(driver).double_click(double).perform()   
        time.sleep(1) 
        #获取页面的上层和本层窗口
        driver.switch_to_window(nowhandle)
