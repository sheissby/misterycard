...
class zdh_ylzl_sub(unittest.TestCase):
    ...
    def test_zdh_ylzl_sub(self):
        ...
        driver.find_element_by_id("ebc55c11-3316-4ab5-81c5-9d73a60096db").send_keys(u'85')
        time.sleep(1)
      
        #整改意见检查人选择+++++++++++++++++++++++++++++++++++++
        #双击选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[4]/td/img")
        ...
        #收件人选择+++++++++++++++++++++++++++++++++++++
        #双击收件人选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[7]/td/img")
        ActionChains(driver).double_click(double).perform()   
        time.sleep(1) 
        #获取页面的上层和本层窗口
        driver.switch_to_window(nowhandle)
