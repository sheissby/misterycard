...
#案例
class zdh_lxwx_sub(unittest.TestCase):
    def setUp(self):
        ...
        #定义公文标题+当前时间的函数
        self.sub_text='lxwx_sub'+now
        #定义公文收件人、申请人、申请人电话
        self.sub_text2=u'符晓玲'
        self.sub_text3=u'冯学冠'
        self.sub_text4=u'13398991939'
        #显示用例名称
        print u'---------------《零星维修申请单 提交功能自动化测试》----------------------'
        
    def test_zdh_lxwx_sub(self):
        ...
        #点击零星维修申请单 链接
        driver.find_element_by_xpath("html/body/div[2]/div/table[2]/tbody/tr/td[2]/div/ul/li/table/tbody/tr/td[2]/a").click()
        time.sleep(1)   
        ...
        driver.find_element_by_id("aa82e4ce-ee17-4447-bc19-29ae9056caad").clear()
        driver.find_element_by_id("aa82e4ce-ee17-4447-bc19-29ae9056caad").send_keys(self.sub_text4)
        time.sleep(1)
        ...
        #定位到CSS，然后取第5个img，进行双击，打开选择按钮
        css1=driver.find_element_by_css_selector('.doc_content')
        #遍历下方的img
        img1=css1.find_elements_by_tag_name('img')
        #取第5个img
        ActionChains(driver).double_click(img1[4]).perform()
        time.sleep(1)
        #获取页面的上层和本层窗口
        ...
        #获取字段值++++++++++++++++++++++++++++++++++++++++
        #获取申请科室、申请时间、维修单号、缓急、密级、正文附件的字段值
        self.sub_text5=driver.find_element_by_id("SelectOnlyAccount_txbText7").get_attribute('value')
        self.sub_text6=driver.find_element_by_id("76202ee5-01c9-4f5b-bfd3-258e9251b1ad").get_attribute('value')
        self.sub_text7=driver.find_element_by_id("001aad14-19ba-46cc-8031-309bd39189b8").get_attribute('value')
...
##        time.sleep(1)
        ...
        ddlDetailType.find_element_by_xpath("//option[@value='tb169']").click()
        time.sleep(1)
        ...
        try:
            ...
            self.assertEqual(text,u'零星维修申请单')
            print u'公文签批的结果列表里标题“'+self.sub_text+u'”的公文类型是“零星维修申请单”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'公文签批的结果列表里标题“'+self.sub_text+u'”的公文类型不是“零星维修申请单”'
        #标题字段判断
        try:
        ...
        try:
            ...
            print u'申请科室字段值“'+text+'"与呈报时的值"'+self.sub_text5+'"一致"'+u'”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'申请科室字段值“'+text+'"与呈报时的值"'+self.sub_text5+'"不一致"'+u'”' 
        #判断申请时间字段
        try:
            text=driver.find_element_by_xpath(".//*[@id='76202ee5-01c9-4f5b-bfd3-258e9251b1ad']").text
        ...
        try:
            ...
            print u'申请人电话字段值“'+text+'"与呈报时的值"'+self.sub_text4+'"一致"'+u'”' 
        except AssertionError as e:
            self.verificationErrors.append(str(e))
            print u'申请人电话字段值“'+text+'"与呈报时的值"'+self.sub_text4+'"不一致"'+u'”'
        #判断缓急字段
        try:
            text=driver.find_element_by_xpath(".//*[@id='Content']/table/tbody/tr[12]/td[1]/span").text
        ...
        #判断密级字段
        try:
            text=driver.find_element_by_xpath(".//*[@id='Content']/table/tbody/tr[12]/td[2]/span").text
