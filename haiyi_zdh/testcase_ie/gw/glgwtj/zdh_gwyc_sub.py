...
class zdh_gwyc_sub(unittest.TestCase):
    ...
    def test_zdh_gwyc_sub(self):
        ...
        #双击开始时间选择+++++++++++++++++++
        double=driver.find_element_by_id("c273307c-6481-45e3-9969-cbd4b66cebe3")
        ...
        #结束时间选择++++++++++++++++++++++
        #双击结束时间
        double=driver.find_element_by_id("879bf094-2ffe-420b-9758-ce910c4bf3b5")
        ActionChains(driver).double_click(double).perform() 
        time.sleep(1)
        #定位到iframe frameborder="0" 的div style的xpath路径
        frame=driver.find_element_by_xpath('/html/body/div[3]')
        ...
        #用车科室负责人选择+++++++++++++++++++++++++++++++++++++
        #双击选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[6]/td[2]/img")
        ActionChains(driver).double_click(double).perform()   
        time.sleep(1) 
        #获取页面的上层和本层窗口
        ...
        #收件人选择+++++++++++++++++++++++++++++++++++++
        #双击收件人选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[9]/td/img")
        ActionChains(driver).double_click(double).perform()   
        time.sleep(1) 
        #获取页面的上层和本层窗口
        driver.switch_to_window(nowhandle)
