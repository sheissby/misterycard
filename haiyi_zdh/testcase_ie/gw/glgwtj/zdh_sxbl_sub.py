...
class zdh_sxbl_sub(unittest.TestCase):
    ...
    def test_zdh_sxbl_sub(self):
        ...
        #事项承办部门选择++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        #双击机构选择按钮       
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[4]/td[2]/img")
        ...
        #收件人选择+++++++++++++++++++++++++++++++++++++
        #双击收件人选择按钮
        double=driver.find_element_by_xpath(".//*[@id='doc_main']/div[2]/table/tbody/tr[6]/td/img")
        ActionChains(driver).double_click(double).perform()   
        time.sleep(1) 
        #获取页面的上层和本层窗口
        driver.switch_to_window(nowhandle)
