...
class zdh_bwcp_lc(unittest.TestCase):
    def setUp(self):
        ...
        #self.add_text='bwcp_lc20160901180233'
        #self.hq='bwcp_lc_hq20160901180233'
        self.tj_text=u'冯学冠'
        self.qp_text=u'符晓玲'
        self.hq1_text=u'黄植'
        self.hq2_text=u'谭壮华'
...
##        driver.find_element_by_xpath(".//*[@id='tbFilePost_OK']").click()
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'流程名称“'+self.add_text+u'”，标题或签批状态或发送人不正确'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'12.png')
...
##        driver.find_element_by_xpath(".//*[@id='tbFilePost_OK']").click()
        ...
        driver = self.driver
        nowhandle=driver.current_window_handle
        above=driver.find_element_by_xpath(".//*[@id='nav-98bce320-dc6e-4fb4-9fae-de494ab9acfd']/a").click()
        time.sleep(2)
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'没有存在流程名称“'+self.add_text+'”'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'13.png')
        ...
        try:
            ...
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'14.png')
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'没有存在流程名称“'+self.add_text+'”'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'15.png')
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'流程名称“'+self.add_text+u'”，标题或签批状态或发送人不正确'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'16.png')
        ...
        #js="$(\"input[id='ddlDetailType']\").removeAttr('readonly');$(\"input[id='ddlDetailType']\").attr('value','100402')"
        #driver.execute_script(js)
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'没有存在流程名称“'+self.add_text+'”'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'17.png')
        ...
        try:
            ...
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'18.png')
            print u'错误截图：'+self.img_text+'18.png'
        driver.quit()
        ...
        try:
            ...
            self.verificationErrors.append(str(e))
            print u'没有存在流程名称“'+self.hq+'”'
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'19.png')
            print u'错误截图：'+self.img_text+'19.png'
            return
        #判断标题、公文类型、创建人是否正确
        try:
            ...
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'20.png')
            print u'错误截图：'+self.img_text+'20.png'
        driver.quit()
        print self.qp_text+u'完成在公文查询查询流程（签批）'
        #完成签批人（符晓玲）在公文查询里，查看流程（签批）是否正确---------------------
        #提交人（冯学冠）在待阅事务里，查看流程是否正确，并分发（黄娜）-----------
        ...
        while 1:
            ...
            if len(text)==0:
                ...
                ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'21.png')
                print u'错误截图：'+self.img_text+'21.png'
                break
            #提取出里面的数字
            ...
            #获取总页数
            num2=nums[1]
            #经验值，暂停2s，不然多页的情况下，经常出现获取的drs与第一次一样
            time.sleep(2)
        ...
        if index==1:
            ...
            self.verificationErrors.append('data of Transaction to be read erro')
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'22.png')
            print u'错误截图：'+self.img_text+'22.png'
            return
        #完成流程暂存待阅，并分发给组*********
        #查询暂存是否成功，且是否处于已阅******
        driver.switch_to_window(nowhandle)
        ...
        while 1:
            ...
            if len(text)==0:
                print u'在公文草稿箱获取页数出错'
                self.verificationErrors.append('data of Transaction to be read erro')
                ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'23.png')
                print u'错误截图：'+self.img_text+'23.png'
                break
            #提取出里面的数字
            nums=re.findall(r"\d+\.?\d*",text)
            #获取当前页数
        ...
        if index==1:
            ...
            print u'在待阅事务里没有存在流程名称：”'+self.add_text+'“，或者信息不正确'
            self.verificationErrors.append('data of Transaction to be read erro')
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'24.png')
            print u'错误截图：'+self.img_text+'24.png'
            return
        #完成查询暂存是否成功，且是否处于已阅******
        driver.quit()
        ...
        while 1:
            ...
            if len(text)==0:
                print u'在公文草稿箱获取页数出错'
                self.verificationErrors.append('data of Transaction to be read erro')
                ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'25.png')
                print u'错误截图：'+self.img_text+'25.png'
                break
            #提取出里面的数字
            nums=re.findall(r"\d+\.?\d*",text)
            #获取当前页数
            ...
            if len(drs)>0:
                for i in range(len(drs)-1):#由于一般表都有表头，而表头只是一些标题而已不是需要的数据所以len(drs)-1
                    ...
                    cbr_text=driver.find_element_by_xpath(xpath4).text
                    ydzt_text=driver.find_element_by_xpath(xpath5).text
                    print bt_text+gwlx_text+ffr_text+cbr_text+ydzt_text
        ...
        if index==1:
            ...
            ImageGrab.grab().save(os.getcwd().split('testcase_ie')[0]+'\\img\\'+self.img_text+'26.png')
            print u'错误截图：'+self.img_text+'26.png'
            return
