...
##        time.sleep(1)
        ...
        driver.find_element_by_id("txbTitle").clear()
        driver.find_element_by_id("txbTitle").send_keys(self.sub_text)
        js="$(\"input[id='ctrStartDate']\").removeAttr('readonly');$(\"input[id='ctrStartDate']\").attr('value','2016-01-01')"
        driver.execute_script(js)
        js="$(\"input[id='ctrEndDate']\").removeAttr('readonly');$(\"input[id='ctrEndDate']\").attr('value','12-30')"
        driver.execute_script(js)
        time.sleep(1)
        #定位和选择公文类型的下拉框
        ddlType=driver.find_element_by_id('ddlType')
