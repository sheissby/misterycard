...
class zdh_cymb_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='cymb_del'+now
        self.img_text='img_cymb_del_error'
    
    def test_zdh_cymb_del(self):
        u"""删除常用模板"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_id("txbTitle").send_keys(u'常用模板')
        time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element_by_id("Page_TitleControlId").send_keys(self.del_text)
        ...
        #给附件赋个空值
        time.sleep(1)
        driver.find_element_by_id("Control_52c9cafd_cbc4_45a1_9310_81f26f71c16e_IbtnAppend").send_keys('')
        ...
        driver.switch_to_window(allhandlelist[1])
        time.sleep(1)
        driver.find_element_by_id("Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd").clear()
        driver.find_element_by_id("Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd").send_keys(self.del_text)
        driver.find_element_by_id("ibtSubmit").click()
        time.sleep(1)
        try:
