...
class zdh_cymb_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='cymb_add'+now
        self.img_text='img_cymb_add_error'
    
    def test_zdh_cymb_add(self):
        u"""添加常用模板"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_e75970cf_64d9_46d3_8c3b_2635f5880fdd']").send_keys(self.add_text)
