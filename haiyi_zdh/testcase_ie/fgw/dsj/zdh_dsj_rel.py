...
class zdh_dsj_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='dsj_rel'+now
        self.img_text='img_dsj_del_error'
    
    def test_zdh_dsj_rel(self):
        u"""发布大事记"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='txbTitle']").send_keys(u'大事记')
        time.sleep(1)
        ...
        driver.switch_to_window(allhandlelist[1])
        time.sleep(1)
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(self.rel_text)
        ...
        driver=self.driver
        above=driver.find_element_by_xpath(".//*[@id='nav-18dc0491-0140-4e4f-8d09-6ef1bd24a800']/a")
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-63dd92bb-a91d-41e7-8708-671edb2a51cf']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_d51c9842_a62c_43de_89d8_f70fcf1c07a5']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_d51c9842_a62c_43de_89d8_f70fcf1c07a5']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
