...
class zdh_dsj_add(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.add_text='dsj_add'+now
        self.img_text='img_dsj_add_error'
    
    def test_zdh_dsj_add(self):
        u"""添加大事记"""
        driver = self.driver
        allhandlelist=[]
        ...
        time.sleep(1)
        driver.find_element_by_id("Page_TitleControlId").send_keys(self.add_text)
        #driver.find_element_by_id("CustomrichTextBox").send_keys(self.add_text)
        ...
        time.sleep(1)
        #给附件赋个空值
        driver.find_element_by_xpath(".//*[@id='Control_2664e971_2eb5_44f5_b167_81903e2d1c29_IbtnAppend']").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(self.add_text)
