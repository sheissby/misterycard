...
class zdh_dsj_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='dsj_del'+now
        self.img_text='img_dsj_del_error'
    
    def test_zdh_dsj_del(self):
        u"""删除大事记"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_a47193a7_ba6c_4db4_8546_6cddf527720d']").send_keys(self.del_text)
