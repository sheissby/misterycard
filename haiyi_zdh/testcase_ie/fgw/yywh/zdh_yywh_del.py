...
class zdh_yywh_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='yywh_del'+now
        self.img_text='img_yywh_del_error'
    
    def test_zdh_yywh_del(self):
        u"""添加医院文化"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_54d74d16_6f98_4943_9cc2_ad09bad8fe9c']").send_keys(self.del_text)
