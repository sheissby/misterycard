...
class zdh_dwgk_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_dwgk_edt_error'
    
    def test_zdh_dwgk_edt(self):
        u"""修改党务公开"""
        driver = self.driver
        allhandlelist=[]
        ...
        time.sleep(1)
        #添加信息
        edt_text='dwgk_edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
...
##        driver.switch_to_window(allhandlelist[1])
        ...
        time.sleep(2)
        #完成信息添加
        edt2_text='dwgk_2edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        #删除没有的窗口句柄
        allhandlelist.pop()
        time.sleep(1)
        ...
        driver.find_element_by_xpath(".//*[@id='Control_605af416_b00c_4db9_9e0e_37f13214890d']").send_keys(edt_text)
...
##      driver.find_element_by_xpath(".//*[@id='CustomrichTextBox']").send_keys(edt2_text)
        ...
        driver.switch_to_window(allhandlelist[1])
        driver.find_element_by_xpath(".//*[@id='Control_605af416_b00c_4db9_9e0e_37f13214890d']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_605af416_b00c_4db9_9e0e_37f13214890d']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
