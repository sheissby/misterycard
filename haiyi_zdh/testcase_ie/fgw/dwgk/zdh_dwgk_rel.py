...
class zdh_dwgk_rel(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.rel_text='dwgk_rel'+now
        self.img_text='img_dwgk_rel_error'
    
    def test_zdh_dwgk_rel(self):
        u"""发布党务公开"""
        driver = self.driver
        allhandlelist=[]
...
##        time.sleep(1)
##        os.startfile(r"D:\selenium+python\windowsexe\docx.exe")
##        time.sleep(5)
...
##        driver.switch_to_window(allhandles[1])
        ...
        driver.find_element_by_xpath(".//*[@id='Control_605af416_b00c_4db9_9e0e_37f13214890d']").send_keys(self.rel_text)
        ...
        ActionChains(driver).move_to_element(above).perform()
        driver.find_element_by_xpath(".//*[@id='nav-4d5c6c49-f842-4f9d-8e1f-538d345241f8']/a").click()
        time.sleep(2)
        driver.switch_to_frame("diaConIf")
        driver.find_element_by_xpath(".//*[@id='Control_46db46ad_f723_41ac_876d_a3e6c68ef947']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_46db46ad_f723_41ac_876d_a3e6c68ef947']").send_keys(self.rel_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(2)
        try:
