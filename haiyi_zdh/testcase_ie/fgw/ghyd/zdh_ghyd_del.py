...
class zdh_ghyd_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='ghyd_del'+now
        self.img_text='img_ghyd_del_error'
    
    def test_zdh_ghyd_del(self):
        u"""删除工会园地"""
        driver = self.driver
        allhandlelist=[]
        nowhandle=driver.current_window_handle
        allhandlelist.append(nowhandle)
        above=driver.find_element_by_xpath(".//*[@id='nav-c6abd59e1ee1']/a")
        ...
        driver.find_element_by_xpath(".//*[@id='Control_19a027f1_b937_4ba2_aa94_657b77a8180d']").send_keys(self.del_text)
