...
class zdh_szyw_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_szyw_edt_error'
    
    def test_zdh_szyw_edt(self):
        u"""修改时政要闻"""
        driver = self.driver
        allhandlelist=[]
        ...
        time.sleep(1)
        #添加信息
        edt_text='gsl_edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        ...
        #完成添加
        #修改信息
        edt2_text='gsl_2edt'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        #删除没有的窗口句柄
        allhandlelist.pop()
        time.sleep(1)
        ...
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandlelist[1])
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
