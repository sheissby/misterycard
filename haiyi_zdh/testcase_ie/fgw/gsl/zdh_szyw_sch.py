...
class zdh_szyw_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='gsl_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_szyw_sch_error'
        
    def test_zdh_szyw_sch(self):
        u"""查询时政要闻"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_91eda4ee_15c3_4b1f_b1ad_88f7ec9de3f3']").send_keys(self.sch_text)
