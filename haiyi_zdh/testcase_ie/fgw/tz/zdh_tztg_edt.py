...
class zdh_tztg_edt(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.img_text='img_tztg_edt_error'
    
    def test_zdh_tztg_edt(self):
        u"""修改通知通告"""
        driver = self.driver
        allhandlelist=[]
...
##        driver.switch_to_window(allhandles[1])
        ...
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").send_keys(edt_text)
        ...
        driver.switch_to_window(allhandlelist[1])
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").clear()
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").send_keys(edt2_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
