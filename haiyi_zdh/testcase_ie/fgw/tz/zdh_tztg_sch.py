...
class zdh_tztg_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='tztg_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_tztg_sch_error'
        
    def test_zdh_tztg_sch(self):
        u"""查询通知通告"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_18cdd8e9_8413_4b32_86db_4ae7265ebcfd']").send_keys(self.sch_text)
