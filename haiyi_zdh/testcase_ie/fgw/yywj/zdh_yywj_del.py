...
class zdh_yywj_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='yywj_del'+now
        self.img_text='img_yywj_del_error'
    
    def test_zdh_yywj_del(self):
        u"""删除医院文件"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_60a7e30c_ef53_4999_a8fa_6b056075d481']").send_keys(self.del_text)
        driver.find_element_by_xpath(".//*[@id='ibtSubmit']").click()
        time.sleep(1)
        try:
            driver.find_element_by_xpath(".//*[@id='dgListRecord']/tbody/tr[2]/td[7]/a").click()
        except AssertionError as e:
            self.verificationErrors.append(str(e))
