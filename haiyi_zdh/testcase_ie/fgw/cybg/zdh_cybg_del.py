...
class zdh_cybg_del(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        now = time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.del_text='cybg_del'+now
        self.img_text='img_cybg_del_error'
    
    def test_zdh_cybg_del(self):
        u"""删除常用表格"""
        driver = self.driver
        allhandlelist=[]
        ...
        #给附件赋个空值
        time.sleep(1)
        driver.find_element_by_id("Control_2f192075_4882_4511_966a_833251ac5841_IbtnAppend").send_keys('')
        ...
        driver.find_element_by_xpath(".//*[@id='Control_46d6558c_aa37_428b_9a50_60fd844581b3']").send_keys(self.del_text)
