...
class zdh_glgd_sch(unittest.TestCase):
    def setUp(self):
        login.login_admin(self)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.sch_text='sch'
        self.add_sch_text='glgd_sch'+time.strftime("%Y%m%d%H%M%S", time.localtime())
        self.img_text='img_ghyd_sch_error'
        
    def test_zdh_glgd_sch(self):
        u"""查询管理规定"""
        driver = self.driver
        allhandlelist=[]
        ...
        driver.find_element_by_xpath(".//*[@id='Control_f080c6e8_7f60_4232_a1c9_24f6feeb8c5e']").send_keys(self.sch_text)
