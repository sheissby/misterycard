...
def con():
    ...
    param0="uid=2014121327096245&sessionid=tbmXwubvxzvP4nHa&Udid=58%3A44%3A98%3A53%3A03%3AAA&plat=ANDROID%5FXIAOMI&newguide=1&IDFA="
...
##    print ppsign,sign,times
    ...
    params=urllib.urlencode({'access%5Ftoken':'','plat':'ANDROID%5FXIAOMI','nick':'2014121327096245','newguide':'1',
                             'time':times,'ppsign':ppsign,'sign':sign,'MUid':'288121','Devicetoken':'','Origin':'xiaomi',
                             'IDFA':'','uin':'2014121327096245','Udid':'58%3A44%3A98%3A53%3A03%3AAA'})
    a='&ppsign='+ppsign
    b='&sign='+sign
    c='&time='+times
    param0="access%5Ftoken=&plat=ANDROID%5FXIAOMI&MUid=288121&newguide=1&uin=2014121327096245&Devicetoken=&Origin=xiaomi&IDFA=&nick=2014121327096245&Udid=58%3A44%3A98%3A53%3A03%3AAA"+c+b+a
##    print param0
##    print params
