...
def legionattack(*id1):
    ...
    header1={'Host':'s2.xiaomi.mysticalcard.com','Cookie':'_sid=d3kv2cgc086bs71ujmg746qqd3',
             'Accept':'text/xml, application/xml, application/xhtml+xml, text/html;q=0.9, text/plain;q=0.8, text/css, image/png, image/jpeg, image/gif;q=0.8, application/x-shockwave-flash, video/mp4;q=0.9, flv-application/octet-stream;q=0.8, video/x-flv;q=0.7, audio/mp4, application/futuresplash, */*;q=0.5',
             'User-Agent':'Mozilla/5.0 (Android; U; zh-CN) AppleWebKit/533.19.4 (KHTML, like Gecko) AdobeAIR/18.0','x-flash-version':'16,0,0,276',
             'Connection':'Keep-Alive','Cache-Control':'no-cache','Referer':'app:/assets/CardMain.swf','Content-Type':'application/x-www-form-urlencoded'
             }
    param0='&Id=9&Type=1'
    param1='&Id=9&Type=2'
    conn=httplib.HTTPConnection("s2.xiaomi.mysticalcard.com")
    conn.request("POST","/legionattack.php?do=join&v=4103&phpp=ANDROID_XIAOMI&phpl=ZH_CN&pvc=1.7.1&pvb=2015-09-25%2017%3A07%3A26&platformtype=1",param0,header1)
    conn=httplib.HTTPConnection("s2.xiaomi.mysticalcard.com")
    conn.request("POST","/legionattack.php?do=exit&v=4103&phpp=ANDROID_XIAOMI&phpl=ZH_CN&pvc=1.7.1&pvb=2015-09-25%2017%3A07%3A26&platformtype=1",param1,header1)
    x=conn.getresponse()
    conn.close()


id=[['2014061866519756','278986'],['2014061866528941','279006'],['2014052561883286','278956'],['2014061766465489','278958'],['2014061866519659','278984'],['2014061866529032','279007'],['2014061866529097','279009'],['2014061866529223','279045'],['2014061866529231','279049',],['2014061866529288','279053'],['2014061866529337','279054'],['2014061866529346','279080'],['2014061866529379','279081'],['2014061866529407','279083'],['2014061866529462','279085'],['2014061866529470','279086'],['2014061866529500','279117'],['2014061866529554','279119'],['2014061866529628','279122'],['2014061866529641','279131'],['2014061866529643','279137'],['2014061866529675','279164'],['2014061866529735','279165'],['2014061866529744','279166']]
for id1 in id:
    legionattack(*id1)
    print 'id1====================',id1
 ##   play_tower(*id1)