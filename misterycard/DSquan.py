...
def BuyDSquan(*id1):
    # con_log(*id1)
    url = 'http://s1.xiaomi.mysticalcard.com/shop.php?do=Buy&v=1878&phpp=ANDROID_XIAOMI&phpl=ZH_CN&pvc=1.7.1&pvb=2015-09-25%2017%3A07%3A26&platformtype=1'
    ...
    data = 'SBshilianchou=0&Chip=1&GoodsId=3'
