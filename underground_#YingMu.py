...
def con():
    header1={'Host':'master.xiaomi.mysticalcard.com','Cookie':'_sid=f8to85cvamr3nvkek4r65r0mg6',
    ...
    param0="uid=5047214&sessionid=0niwv4OngcXD5tXg&Udid=08%3A00%3A27%3A8D%3A25%3A75&plat=ANDROID%5FXIAOMI&newguide=1&IDFA="
...
##    print ppsign,sign,times
    header1={'Host':'s2.xiaomi.mysticalcard.com','Cookie':'_sid=dlus1qduhmro1umh2jq9m3pba1',
             'Accept':'text/xml, application/xml, application/xhtml+xml, text/html;q=0.9, text/plain;q=0.8, text/css, image/png, image/jpeg, image/gif;q=0.8, application/x-shockwave-flash, video/mp4;q=0.9, flv-application/octet-stream;q=0.8, video/x-flv;q=0.7, audio/mp4, application/futuresplash, */*;q=0.5',
             'User-Agent':'Mozilla/5.0 (Android; U; zh-CN) AppleWebKit/533.19.4 (KHTML, like Gecko) AdobeAIR/18.0','x-flash-version':'18,0,0,161',
             'Connection':'Keep-Alive','Cache-Control':'no-cache','Referer':'app:/assets/CardMain.swf','Content-Type':'application/x-www-form-urlencoded'
             }
    params=urllib.urlencode({'access%5Ftoken':'','plat':'ANDROID%5FXIAOMI','nick':'5047214','newguide':'1',
                             'time':times,'ppsign':ppsign,'sign':sign,'MUid':'198633','Devicetoken':'','Origin':'xiaomi',
                             'IDFA':'','uin':'5047214','Udid':'08%3A00%3A27%3A8D%3A25%3A75'})
    a='&ppsign='+ppsign
    b='&sign='+sign
    c='&time='+times
    param0="access%5Ftoken=&plat=ANDROID%5FXIAOMI&MUid=198633&newguide=1&uin=5047214&Devicetoken=&Origin=xiaomi&IDFA=&nick=5047214&Udid=08%3A00%3A27%3A8D%3A25%3A75"+c+b+a
##    print param0
##    print params
...
def fight():
    ...
    temp=con_log()
##    print temp.status,temp.reason,temp.read()
    while 1:            
