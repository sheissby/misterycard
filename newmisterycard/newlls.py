...
def get_lls_info(id):
    # 获取lls信息
    data =''
    url = host + '/Journey.php?do=GetUserJourneysStatus&v=1522&phpp=ANDROID&phpl=ZH_CN&pvc=1.9.0&pvb=2016-08-02%2015%3A37%3A49&platformtype=1'
...
def get_cd(llsid):
    ...
    url = host + '/Journey.php?do=GetUserJourneyInfo&v=1523&phpp=ANDROID&phpl=ZH_CN&pvc=1.9.0&pvb=2016-08-02%2015%3A37%3A49&platformtype=1'
...
def fight_lls(llsid):
    data = 'userJourneyId=' + str(llsid)
    url = host + '/Journey.php?do=JourneyFight&v=1525&phpp=ANDROID&phpl=ZH_CN&pvc=1.9.0&pvb=2016-08-02%2015%3A37%3A49&platformtype=1'
    flg, jsonresponse = connectionuntilsuccess(url, data)
...
def need_explore(cd):
    while 1:
        ...
        url = host + '/mapstage.php?do=Explore&v=1524&phpp=ANDROID&phpl=ZH_CN&pvc=1.9.0&pvb=2016-08-02%2015%3A37%3A49&platformtype=1'
...
def GetJourneyPointReward(enableAwardList):
    url = host + '/Journey.php?do=GetJourneyPointReward&v=9156&phpp=ANDROID&phpl=ZH_CN&pvc=1.9.0&pvb=2016-08-02%2015%3A37%3A49&platformtype=1'
